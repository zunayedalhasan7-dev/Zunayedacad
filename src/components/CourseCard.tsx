...
export default function CourseCard({ id, title, instructor, price, originalPrice, rating, thumb, badge }: CourseCardProps) {
  ...
  return (
    <div style={{ perspective: 1000 }} className="snap-center h-full">
      <motion.div 
        ref={cardRef}
        ...
        className="bg-white  rounded-2xl overflow-hidden border border-slate-200 shadow-sm hover:shadow-sm hover:border-primary-100 transition-colors flex flex-col min-w-[280px] sm:min-w-0 group h-full relative"
      >
